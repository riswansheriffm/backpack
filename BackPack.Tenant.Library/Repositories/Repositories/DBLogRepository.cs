...
{
    public class DBLogRepository(IConfiguration configuration) : GenericRepository(configuration), IDBLogRepository
    {
        ...
        public async Task<bool> CreateRequestAsync(DBLogRequest request)
        {
            ...
            try
            {
                ...
                parameters.Add("ip_service_log_id", request.ServiceLogID, DbType.Guid);
                ...
                await dbConnection.ExecuteAsync(ServiceConstant.SchemaMasters + ProcedureConstant.CreateServiceLog, parameters, commandType: CommandType.StoredProcedure);
        ...
        public async Task<bool> UpdateRequestAsync(DBLogRequest request)
        {
            ...
            try
            {
                ...
                await dbConnection.ExecuteAsync(ServiceConstant.SchemaMasters + ProcedureConstant.UpdateServiceLog, parameters, commandType: CommandType.StoredProcedure);
