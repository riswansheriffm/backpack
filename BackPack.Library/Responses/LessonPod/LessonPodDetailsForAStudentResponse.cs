...
{
    public class LessonPodDetailsForAStudentResponse : ReadBaseResponse
    {
        public LessonPodDetailsForAStudentResult Data { get; set; } = new();
    }

    public class LessonPodDetailsForAStudentResult
    {
        public List<LessonPodDetailsForAStudentData> GetLessonUnitDetailsForAStudentResult { get; set; } = [];
    }

    public class LessonPodDetailsForAStudentData
    {
