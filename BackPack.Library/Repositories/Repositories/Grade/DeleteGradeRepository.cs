...
{
    public class DeleteGradeRepository : GenericRepository, IDeleteGradeRepository
    {
        ...
        public async Task<BaseResponse> DeleteGradeAsync(DeleteGradeRequest request)
        {
            ...
            try
            {
                ...
                userParameters.Add("ip_activity_desc", LogMessage.DeleteGrade, DbType.String);
                ...
                await dbConnection.ExecuteAsync(ServiceConstant.SchemaMasters + ProcedureConstant.DeleteGrade, userParameters, sqlTransaction, commandType: CommandType.StoredProcedure);
                ...
                if (ReturnStatusID > 0)
                {
                    ...
                    return new BaseResponse()
                    {
                        ...
                        StatusMessage = GradeMessage.DeleteGrade
                    };
                }
                else
                {
                    ...
                    return new BaseResponse()
                    {
                        ...
                        StatusMessage = GradeMessage.DeleteCreationFail
                    };
                }
