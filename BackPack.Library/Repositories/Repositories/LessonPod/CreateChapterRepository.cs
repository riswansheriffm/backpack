...
{
    public class CreateChapterRepository : GenericRepository, ICreateChapterRepository
    {
        ...
        public async Task<BaseResponse> CreateChapterAsync(CreateChapterRequest request)
        {
            ...
            try
            {
                ...
                userParameters.Add("ip_activity_desc", LogMessage.CreateChapter, DbType.String);
                ...
                await dbConnection.ExecuteAsync(ServiceConstant.SchemaMasters + ProcedureConstant.CreateChapter, userParameters, sqlTransaction, commandType: CommandType.StoredProcedure);
                ...
                if (ReturnStatusID == 0)
                {
                    ...
                    return new BaseResponse()
                    {
                        ...
                        StatusMessage = ChapterMessage.ChapterCreationFail
                    };
                }
                else if (ReturnStatusID == 1)
                {
                    ...
                    return new BaseResponse()
                    {
                        ...
                        StatusMessage = ChapterMessage.CreateChapter
                    };
                }
                else if (ReturnStatusID == 2)
                {
                    ...
                    return new BaseResponse()
                    {
                        ...
                        Success = false,
                        StatusCode = StatusCodes.Status400BadRequest,
                        StatusMessage = ChapterMessage.ChapterCreationDuplicate
                    };
                }
                else
                {
