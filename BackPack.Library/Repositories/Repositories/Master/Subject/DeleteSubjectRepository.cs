...
{
    public class DeleteSubjectRepository : GenericRepository, IDeleteSubjectRepository
    {
        ...
        public async Task<BaseResponse> DeleteSubjectAsync(DeleteSubjectRequest request)
        {
            ...
            try
            {
                ...
                userParameters.Add("ip_activity_desc", LogMessage.DeleteSubject, DbType.String);
                ...
                await dbConnection.ExecuteAsync(ServiceConstant.SchemaMasters + ProcedureConstant.DeleteStudent, userParameters, sqlTransaction, commandType: CommandType.StoredProcedure);
                ...
                if (ReturnStatusID > 0)
                {
                    ...
                    return new BaseResponse()
                    {
                        ...
                        StatusMessage = MasterMessage.DeleteSubject
                    };
                }
                else
                {
                    ...
                    return new BaseResponse()
                    {
                        ...
                        StatusMessage = MasterMessage.DeleteCreationFail
                    };
                }
                #endregion
            }
