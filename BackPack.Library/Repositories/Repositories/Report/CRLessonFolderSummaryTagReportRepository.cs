...
{
    public class CRLessonFolderSummaryTagReportRepository : GenericRepository, ICRLessonFolderSummaryTagReportRepository
    {
        ...
        public async Task<CRLessonFolderSummaryTagReportResponse> CRLessonFolderSummaryTagReportAsync(int LessonID)
        {
            ...
            CRLessonFolderSummaryTagReportResponse response = new();
            CRLessonFolderSummaryTagReportData responseData = new();

            try
            {
                #region Set parameters            
                var tagParameters = new DynamicParameters();
                tagParameters.Add("ip_lesson_id", LessonID, DbType.Int32);
                ...
                var dbTagResponse = await dbConnection.QueryAsync(ServiceConstant.SchemaMasters + "get_tags_by_folder", tagParameters, sqlTransaction, commandType: CommandType.StoredProcedure);
                ...
                var recordSetData = await dbConnection.QueryAsync<CRLessonFolderSummaryTagReportQueryData>(recordSetQuery, sqlTransaction, commandType: CommandType.Text);
                ...
                var summaryRecordSetData = await dbConnection.QueryAsync<CRLessonFolderSummaryTagReportQueryData>(summaryRecordSetQuery, sqlTransaction, commandType: CommandType.Text);
                ...
                List<CRLessonFolderSummaryTagReportStudentData> listData = new();
                if (listStudent.Any())
                {
                    foreach (var student in listStudent)
                    {
                        ...
                        var dbResponse = await dbConnection.QueryAsync(ServiceConstant.SchemaMasters + "get_lesson_folder_summary_tag_report", parameters, sqlTransaction, commandType: CommandType.StoredProcedure);
                        ...
                        var recordTagSetData = await dbConnection.QueryAsync<CRLessonFolderSummaryTagReportQueryData>(recordTagSetQuery, sqlTransaction, commandType: CommandType.Text);
                        ...
                        var summaryRecordTagSetData = await dbConnection.QueryAsync<CRLessonFolderSummaryTagReportQueryData>(summaryRecordTagSetQuery, sqlTransaction, commandType: CommandType.Text);

                        var listStudentName = recordTagSetData.ToList();
                        var listTagData = summaryRecordTagSetData.ToList();

                        CRLessonFolderSummaryTagReportStudentData tagData = new();
                        if (listTagData.Any())
                        {
                ...
                response.Data = new CRLessonFolderSummaryTagReport
                {
                    GetCRLessonFolderSummaryTagReportResult = responseData
                };
