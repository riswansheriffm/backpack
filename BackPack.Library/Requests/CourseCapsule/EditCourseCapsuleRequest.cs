...
{
    public class EditCourseCapsuleRequest
    {
        ...
        public List<EditCourseCapsuleLessonPod>? LessonPods { get; set; }
    }
    public class EditCourseCapsuleLessonPod
    {
        [SwaggerSchema("CourseCapsuleLessonPodID")]
        [SwaggerSchemaExample("99")]
        public int CourseCapsuleLessonPodID { get; set; }
        [SwaggerSchema("LessonPodDeleted")]
        [SwaggerSchemaExample("0")]
        public int LessonPodDeleted { get; set; }
        [SwaggerSchema("IsDeleted")]
        [SwaggerSchemaExample("0")]
        ...
        public List<EditCourseCapsuleActivities>? Activities { get; set; }
    }
    public class EditCourseCapsuleActivities
    {
        [SwaggerSchema("CourseCapsuleActivityID")]
        [SwaggerSchemaExample("0")]
        public int CourseCapsuleActivityID { get; set; }
        [SwaggerSchema("ActivityDeleted")]
        [SwaggerSchemaExample("0")]
